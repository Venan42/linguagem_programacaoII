    ...
    public static void main(String[] args) {
        ...
        while (op) {
            try {
                ...
                System.out.println("-4) Percentual de homens e mulheres -");
                ...
                switch (resp) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        double qtdMulheres = 0, qtdHomens = 0;
                        for(Aluno aluno : alunos){
                        ...
                        double total = qtdHomens + qtdMulheres;
                        System.out.println("Porcentagem de alunos cadastrados: " + (qtdHomens/total)*100 + "%");
                        System.out.println("Porcentagem de alunas cadastradas: " + (qtdMulheres/total)*100 + "%");
                        break;
                    case 5:
